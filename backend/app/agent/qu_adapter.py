...
def _to_session_context(sc_dict: dict[str, Any]) -> SessionContext:
    ...
    return SessionContext(
        ...
        number_of_days=sc_dict.get("number_of_days"),
        number_of_nights=sc_dict.get("number_of_nights"),
        ...
        budget_type=sc_dict.get("budget_type"),
        raw_budget_min=sc_dict.get("raw_budget_min"),
        raw_budget_max=sc_dict.get("raw_budget_max"),
